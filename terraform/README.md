...
```
curl "https://nubesgen.com/demo.zip?iactool=TERRAFORM&region=eastus&application=SPRING_CLOUD.standard&runtime=DOCKER&database=NONE.free&addons=key_vault" | tar -xzvf -
```
